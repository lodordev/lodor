...
// fix; OnionOS/MinUI-family hide() skips dot entries, and the launch path resolves discs
// via the .m3u's relative lines written in lockstep). Returns "" when the ROM has no
// platform slug.
